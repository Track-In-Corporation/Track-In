...
<div class="relative z-10 group w-full" data-input-dropdown-component>
    ...
    <<<<<<< HEAD <div
        class="absolute z-50 inset-0 top-11 border h-fit bg-white shadow-soft rounded-md group-data-[state=open]:opacity-100 group-data-[state=open]:visible group-data-[state=open]:translate-y-0 group-data-[state=open]:scale-100  opacity-0 invisible -translate-y-4 scale-95 transition-all duration-200 p-1"=======<div
        class="absolute inset-0 top-24 border h-fit bg-white shadow-soft rounded-sm group-data-[state=open]:opacity-100 group-data-[state=open]:visible group-data-[state=open]:translate-y-0 group-data-[state=open]:scale-100  opacity-0 invisible -translate-y-4 scale-95 transition-all duration-200 p-1">
        >>>>>> 189d721f3d9ea45083d77d84867cb78acdf13e2d
