...
@section('content')
  <div class="min-h-screen flex justify-center items-center">
      ...
      <!-- Modal -->
      <div class="fixed inset-0 bg-black/40 modal hidden justify-center items-center">
        <!-- Content -->
         <!-- Change This! -->
            ...
            <div class="bg-white p-3 rounded-xl h-full">
              <div class="border-border border-2 border-dashed rounded-xl flex justify-center items-center h-full  p-3 flex-col ">
                ...
                <div class="w-full max-md:grid-cols-1  my-4 grid grid-cols-2 gap-2">
                  <button class="cancelButton shadow-soft animate-cta bg-background rounded-xl py-4 px-4">
                      Tidak, Batalkan
                  </button>

                  <button class="successButton shadow-soft animate-cta py-4 px-4 bg-red text-white rounded-xl">Ya, Saya Yakin</button>
                </div>
              </div>
            </div>
         </div>
