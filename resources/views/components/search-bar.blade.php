...
<form method="GET" action="{{ $route }}" @class(['flex gap-3 items-center h-full', $class])>
    ...
    <input type="text" name="search"
        class="bg-input-background border rounded-md text-sm placeholder:text-tertiary px-3 py-1.5 shadow-soft placeholder:text-sm focus:border-accent focus:outline-1 focus:outline-accent w-full hover:border-secondary"
