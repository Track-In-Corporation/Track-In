...
<div data-window-component-state="{{ $state }}" data-window-component="{{ $name }}"
    @class([
        'data-[window-component-state=open]:opacity-100 data-[window-component-state=open]:visible fixed inset-0 z-999 bg-black/40 opacity-0 invisible flex justify-end p-2 transition-all duration-200  group md:p-0',
    ])>
